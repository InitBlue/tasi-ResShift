...
class BaseSampler:
    ...
    def build_model(self):
        ...
        ckpt_path = r'weights\resshift_realsrx4_s4_v3.pth'
        ...
        if self.configs.autoencoder is not None:
            ...
            autoencoder = util_common.instantiate_from_config(self.configs.autoencoder)
...
class ResShiftSampler(BaseSampler):
    ...
    def inference(self, in_path, out_path, mask_path=None, mask_back=True, bs=1, noise_repeat=False):
        ...
        if in_path.is_dir():
            ...
            im_lq_tensor = util_image.img2tensor(im_lq)
